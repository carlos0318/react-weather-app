...
function App() {
  ...
  return (
    <div className="bg-gray-800 flex items-center justify-center w-screen h-screen py-4">
      <div className="flex w-3/4 min-h-full rounded-3xl shadow-lg m-auto bg-gray-100">
        ...
        <div className="form-container">
          <div className="flex items-center justify-center">
            ...
            <div className="flex p-2 text-gray-100 bg-gray-600 bg-opcaity-30 rounded-lg">
          ...
          <div className="flex flex-col items-center justify-center h-full">
            ...
            >
              <input
                ...
                required
                className="relative rounded-xl py-2 px-3 w-2/3 bg-gray-300 bg-opacity-60 text-white placeholder-gary-200"
              />
        ...
        <div className="w-2/4 p-5">
          ...
          <div className="flex flex-col my-10">
            {weatherData.length === 0 ? (
              <div className="container p-4 flex item-center justify-center h-1/3 mb-auto">
